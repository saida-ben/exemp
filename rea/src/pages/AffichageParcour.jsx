import React from 'react'
    ...
    import { ParcourData,ParcourGrid } from '../data/dummy';
...
const AffichageParcour = () => {
  ...
  const editing = { allowDeleting: true, allowEditing: true ,allowAdding: true};
      ...
      return (
         <><Navbar1/><div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
          <Header category="Page" title="Customers" />
          <GridComponent
            dataSource={ParcourData}
        enableHover={false}
        allowPaging
      ...
      >
            ...
            <ColumnsDirective>
              ...
              {ParcourGrid.map((item, index) => <ColumnDirective key={index} {...item} />)}
            </ColumnsDirective>
